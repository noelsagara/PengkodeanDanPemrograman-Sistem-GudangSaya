...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
               ...
               <li>
                ...
                <a href="?m=supplier&s=awal">
                  <i class="fa fa-building"></i> Data Supplier
                            ...
                            <li>
                <a href="?m=rak&s=awal">
                  <i class="fa fa-briefcase"></i> Data Rak
                </a>
              </li>
                            <li>
                ...
                <a href="?m=barangKeluar&s=awal">
                  <i class="fa fa-truck"></i> Data Barang Keluar
                </a>
              </li>
              <li>
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Haloo Bang, <?php echo $r['nama']; ?></h1>
          </div>
        </div>
        ...
        <div class="row">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading" style="background-color:#499be3;">
                            <div class="row">
                                <div class="col-xs-3">
